 ...
 */
class MigrationGatedAgentEventStore(private val sourceA: AgentEventStore, private val reason: BindingReason) : AgentEventStore {
    override suspend fun append(agentId: String, projectId: String, tsMs: Long, event: StreamJsonEvent): StoredAgentEvent =
        throw storeMigrating("agent_events", reason)
    ...
    override suspend fun deleteByProject(projectId: String): Int = throw storeMigrating("agent_events", reason)
}
