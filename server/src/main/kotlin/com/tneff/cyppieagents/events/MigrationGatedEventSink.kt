 ...
 */
class MigrationGatedEventSink(private val sourceA: EventSink) : EventSink {
    override suspend fun append(draft: EventDraft): Event = throw storeMigrating("event_log")
    override suspend fun appendBatch(drafts: List<EventDraft>): List<Event> = throw storeMigrating("event_log")
    ...
    override suspend fun deleteByProject(projectId: String): Int = throw storeMigrating("event_log")
}
