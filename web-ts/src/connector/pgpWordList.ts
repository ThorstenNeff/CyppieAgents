// CYP-798 — the PGP biometric word lists, PORTED BYTE-IDENTICALLY from :core/PgpWordList.kt (CYP-482).
// DO NOT edit by hand: a single word drift breaks the OOB fingerprint equality. The hubFingerprint.test.ts
// recomputes SHA-256(EVEN.join("\n")+"\n"+ODD.join("\n")) and asserts it == PGP_LIST_SHA256 (the drift guard).
