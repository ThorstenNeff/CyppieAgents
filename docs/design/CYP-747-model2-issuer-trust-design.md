...
> Status: **Design komplett (Rev. 3.4 — PL-§4b-FREIGABE 2026-07-21; A1→Zahn 7(b), A2→Zahn 8(a), B1/B2→§11.1, §14 Bau-Kopplungen. Reviewer-Zahn-Verifikation: GO 7(b)/B1/B2/§14; 8(a) auf Konstruktions-Stellen-Closure umgeschrieben — Fund: Operator-Autorität ist ein Typ-Konstrukt, nicht ein Auflöser; `CpJwtVerifier:36` TUNNEL/device-PoP korrekt eingeordnet). Nächstes Gate: Reviewer re-verifiziert 8(a) → PL-Go am Volltext (7b+8a) → Modell-2-Bau nach CYP-775-Kette. KEIN Bau vor PL-Go.**
