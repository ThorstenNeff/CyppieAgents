...
/**
 * CYP-413 — in-memory actual (Kotlin/JS). The browser stays in-memory **by construction** (R7): a session secret
 * is never written to `localStorage`; the same-origin `ory_kratos_session` cookie is the browser's session
