...
object FirstRunTags {
    ...
    const val REPO_CLONING = "firstRun.repo.cloning"
    const val REPO_CLONING_SLOW = "firstRun.repo.cloningSlow"
    const val REPO_CLONE_OK = "firstRun.repo.cloneOk"
    const val REPO_CLONE_FAILED = "firstRun.repo.cloneFailed"
