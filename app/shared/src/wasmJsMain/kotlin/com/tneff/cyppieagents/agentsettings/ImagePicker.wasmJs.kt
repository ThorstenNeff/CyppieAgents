...
/**
 * Kotlin/Wasm web actual — the **deploy-critical** picker (the public deploy is the wasmJs SPA). A hidden
 * `<input type=file>`; the picked File is read to bytes via [FileReader] (ArrayBuffer → Int8Array → ByteArray).
 */
@Composable
