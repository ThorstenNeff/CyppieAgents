 ...
 * that it fits under this Agent-derived floor is proven separately in `Cyp378CommWindowFloorFitTest`. Together
 * they are the "content window" floor — measuring only one is the one-leg blindness CYP-378 closed.
 *
