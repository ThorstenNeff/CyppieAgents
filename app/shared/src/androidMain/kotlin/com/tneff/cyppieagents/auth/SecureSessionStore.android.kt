...
/**
 * CYP-413 — Phase-1 in-memory actual (Android). R7=session-only. The durable actual is the **Android Keystore**
 * (EncryptedSharedPreferences / DataStore) — **named, not built** here.
 */
